...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://mydoc.my-daktari.com/model/calendar_info.php',
...
function suc(){
    $("#suc").show();
    setTimeout(function(){  $("#suc").hide(); }, 1000);
}
...
form.append("id",id);
var settings = {
  "url": "https://mydoc.my-daktari.com/model/delete_slot.php",
  "method": "POST",
  "timeout": 0,
  "headers": {
...
var settings = {
  "url": "https://mydoc.my-daktari.com/model/delete_day.php",
  "method": "POST",
  "timeout": 0,
  "headers": {
    "Cookie": "PHPSESSID=7e04c50846483facaa7e4b1603f34814"
...
var settings = {
  "url": "https://mydoc.my-daktari.com/model/delete_slots.php",
  "method": "POST",
  "timeout": 0,
  "headers": {
    "Cookie": "PHPSESSID=7e04c50846483facaa7e4b1603f34814"
...
var settings = {
  "url": "https://mydoc.my-daktari.com/model/schedule.php",
  "method": "POST",
  "timeout": 0,
  "headers": {
    "Cookie": "PHPSESSID=7e04c50846483facaa7e4b1603f34814"
...
form.append("token", "<?= $token ?>");
var settings = {
  "url": "https://mydoc.my-daktari.com/model/calendar_info.php",
  "method": "POST",
  "timeout": 0,
  "headers": {
    "Cookie": "PHPSESSID=7e04c50846483facaa7e4b1603f34814"
...
<?php foreach($arr as $value){ 
   ...
   <?php if ($$value){ ?>
    ...
    '</div><i class="fa fa-minus ml-2 mt-2"></i>' +
